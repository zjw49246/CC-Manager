...
async def shared_chat(
    ...
    # PR publication and Delivery transitions use this same per-Task lock.
    # Revalidate all authority before writing the user log so a terminal
    # workflow cannot receive a late remote mutation.
    await db.rollback()
